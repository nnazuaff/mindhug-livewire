...
<div class="min-h-screen flex flex-col lg:flex-row">
    ...
    <div class="hidden lg:flex lg:w-[45%] xl:w-[42%] relative overflow-hidden bg-[#2e1f12] flex-col justify-between p-10 xl:p-14"
        ...
        <div class="absolute top-0 left-0 w-full h-full pointer-events-none" aria-hidden="true">
            ...
            <div
                class="absolute bottom-0 right-0 w-96 h-96 rounded-full bg-[#c19a6b]/8 blur-3xl translate-x-1/3 translate-y-1/3">
            </div>
            <div
                class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 rounded-full bg-[#a47551]/6 blur-3xl">
            </div>
        </div>
            ...
            <div class="w-full max-w-sm">
                ...
                <div class="relative min-h-[5rem]">
                    <template x-for="(q, i) in quotes" :key="i">
                        <div x-show="idx === i" x-transition:enter="transition duration-700 ease-out"
                            x-transition:enter-start="opacity-0 translate-y-3"
                            x-transition:enter-end="opacity-100 translate-y-0"
                            x-transition:leave="transition duration-400 ease-in" x-transition:leave-start="opacity-100"
                            x-transition:leave-end="opacity-0" x-cloak>
                            <p class="font-baloo font-bold text-white text-2xl xl:text-3xl leading-snug"
                                x-text="q.text"></p>
                ...
                <div class="flex gap-1.5 mt-6">
                    <template x-for="(q, i) in quotes" :key="i">
                        <button @click="idx = i" :class="idx === i ? 'bg-[#a47551] w-5' : 'bg-white/20 w-1.5'"
    ...
    <div class="flex-1 flex flex-col items-center justify-center px-6 py-12 sm:px-10 lg:px-16 bg-white">
        ...
        <div class="w-full max-w-md" x-data="{ showPassword: false }">
            <div class="mb-8">
                ...
                <p class="mt-2 text-[#666] text-sm">Daftar untuk mulai curhat, menyimpan sesi, dan menikmati pengalaman
                    personal.</p>
            </div>

            {{-- @if ($errors->any())
                <div class="mb-5 flex items-start gap-3 rounded-2xl bg-red-50 border border-red-100 px-4 py-3.5"
                    x-data="{ show: true }" x-show="show" x-transition:enter="transition duration-300 ease-out"
                    x-transition:enter-start="opacity-0 -translate-y-2"
                    x-transition:enter-end="opacity-100 translate-y-0">
                    <svg class="h-4 w-4 text-red-500 mt-0.5 shrink-0" viewBox="0 0 24 24" fill="none"
            ...
            <form wire:submit.prevent="register" class="space-y-4">
                <div>
                    ...
                    <input id="full_name" wire:model.defer="full_name" type="text" autocomplete="name"
                ...
                <div class="grid sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input id="username" wire:model.defer="username" type="text" autocomplete="username"
                ...
                <div class="grid sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input id="phone" wire:model.defer="phone" type="tel" autocomplete="tel"
                            placeholder="08xxxx"
                    ...
                    <div>
                        <label for="birth_date" class="block text-sm font-medium text-[#3d2b1c] mb-2">Tanggal
                            Lahir</label>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input id="password" wire:model.defer="password" :type="showPassword ? 'text' : 'password'"
                        ...
                        <button type="button" @click.prevent="showPassword = !showPassword"
                            ...
                            <svg x-show="!showPassword" class="h-4.5 w-4.5" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round">
                                <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" />
                                <circle cx="12" cy="12" r="3" />
                            </svg>
                            <svg x-show="showPassword" x-cloak class="h-4.5 w-4.5" viewBox="0 0 24 24"
                ...
                <button type="submit"
                    ...
                    wire:loading.attr="disabled" wire:loading.class="opacity-80 cursor-not-allowed">
            ...
            <div class="mt-7 text-center">
                <p class="text-sm text-[#666]">
                    ...
                    <a href="{{ route('login') }}" wire:navigate
                        class="font-semibold text-[#a47551] hover:text-[#8f6243] transition">
                        Masuk sekarang
                    </a>
                </p>
            </div>
            ...
            <div class="mt-5 text-center">
                <a href="{{ url('/') }}" wire:navigate
                    class="inline-flex items-center gap-1.5 text-xs text-[#999] hover:text-[#555] transition">
