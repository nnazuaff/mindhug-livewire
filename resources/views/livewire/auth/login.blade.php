        ...
        <div class="w-full max-w-md" x-data="{ showPassword: false }">
            ...
            {{-- @if ($errors->any())
                <div class="mb-5 flex items-start gap-3 rounded-2xl bg-red-50 border border-red-100 px-4 py-3.5"
                    ...
                    x-transition:enter-end="opacity-100 translate-y-0">
                    <svg class="h-4 w-4 text-red-500 mt-0.5 flex-shrink-0" viewBox="0 0 24 24" fill="none"
            ...
            <form wire:submit.prevent="login" class="space-y-5">
                ...
                <div>
                    ...
                    <input id="identifier" wire:model.defer="identifier" type="text" autocomplete="username"
                ...
                <div>
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <a href="#" class="text-xs text-[#a47551] hover:text-[#8f6243] transition">Lupa
                            password?</a>
                    </div>
                    <div class="relative">
                        ...
                        <button type="button" @click.prevent="showPassword = !showPassword"
                            ...
                            <svg x-show="showPassword" x-cloak class="h-4.5 w-4.5" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path
