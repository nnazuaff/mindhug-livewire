    ...
    <div class="flex flex-col gap-3 mb-6">
        ...
        <div class="flex flex-col sm:flex-row gap-3 items-start sm:items-center">
            <div class="flex items-center gap-2">
                <label class="text-xs text-stone-500 whitespace-nowrap">Dari</label>
                <input wire:model.live="dateFrom" type="date"
                    class="rounded-xl border border-stone-200 bg-white px-3 py-2 text-sm focus:outline-none focus:border-[#a47551]">
            </div>
            <div class="flex items-center gap-2">
                <label class="text-xs text-stone-500 whitespace-nowrap">Sampai</label>
                <input wire:model.live="dateTo" type="date"
                    class="rounded-xl border border-stone-200 bg-white px-3 py-2 text-sm focus:outline-none focus:border-[#a47551]">
            </div>
            @if ($search || $customerSearch || $statusFilter || $dateFrom || $dateTo)
