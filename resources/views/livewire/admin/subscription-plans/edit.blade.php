        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40" wire:click.self="closeModal">
            <div class="bg-white rounded-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto shadow-xl">
                <div
                    ...
                    <h2 class="text-lg font-semibold text-stone-800">Edit Paket Plus</h2>
                ...
                <form wire:submit.prevent="update" class="p-6 space-y-5">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input wire:model.defer="price" type="number" min="0"
                        ...
                        <div>
                            ...
                            <input wire:model.defer="durationDays" type="number" min="1"
                    ...
                    <div class="flex gap-3 pt-2">
                        ...
                        <button type="submit"
                            class="flex-1 rounded-xl bg-[#a47551] px-4 py-2.5 text-sm font-medium text-white hover:bg-[#8f6243] transition-colors">Simpan
                            Perubahan</button>
                    </div>
                </form>
            </div>
