    ...
    <div class="max-w-6xl mx-auto px-4 py-10">
        <div class="space-y-6">
            <div class="rounded-3xl border border-stone-200 bg-[#fff8f0] p-8 shadow-[0_32px_60px_rgba(34,25,17,0.08)]">
                ...
                <h1 class="mt-4 text-4xl font-semibold tracking-tight text-[#2b1d12]"
                    style="font-family: 'Quicksand', 'Nunito', sans-serif;">Selesaikan pesanan Anda dengan tenang</h1>
                <p class="mt-3 max-w-3xl text-sm leading-7 text-[#6a5a4f]"
                    ...
                    benar sebelum mengonfirmasi. Mindhug menjaga kenyamanan dan keamanan transaksi Anda.</p>
            </div>
